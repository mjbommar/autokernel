...
if __name__ == "__main__":
    MICRO=os.environ.get("AK_KERNEL_MICROVM","/data1/kbuild/bzImage-microvm"); PC=os.environ.get("AK_KERNEL","/data1/kbuild/bzImage-minimal-pc")
    ...
    micro=rep("microvm",          series(boot_micro, n, mtype=mt))
    if base and micro:
